...
![Graph](_static/images/the-monte-carlo-method/graph-1.jpg)
...
![Formula](_static/images/the-monte-carlo-method/formula-1.PNG)

If we evaluate it between 0 and 1:

![Formula](_static/images/the-monte-carlo-method/formula-2.PNG)
...
![Graph](_static/images/the-monte-carlo-method/graph-2.png)
...
![Graph](_static/images/the-monte-carlo-method/graph-3.jpg)
...
![Formula](_static/images/the-monte-carlo-method/formula-3.PNG)

When evaluating "x" between limits 4 and 0 we have:

![Formula](_static/images/the-monte-carlo-method/formula-4.PNG)
...
![Graph](_static/images/the-monte-carlo-method/graph-5.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-6.jpg)

Let's then find the fraction that will indicate the percentage of points that remain within the intersection:

336/1000 = 0.336

![Graph](_static/images/the-monte-carlo-method/graph-7.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-8.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-9.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-10.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-11.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-12.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-13.jpg)
...
![Graph](_static/images/the-monte-carlo-method/graph-14.jpg)
