...
(function () {
    ...
    function attr(elem, prop, value) {
        ...
        if (isString(prop)) {
            ...
            if (defined(value)) {
                ...
                // elem not defined when printing
                // pie demo...
    ...
    pathAnim = {
        ...
        init: function (elem, fromD, toD) {
            ...
            var shift = elem.shift,
                ...
                endBaseLine,
                sixify = function (arr) {
                    // in splines make move points have six
        ...
        step: function (start, end, pos, complete) {
            ...
            if (pos === 1) {
                // land on the final path without adjustment points
            ...
            ($ && {
                ...
                init: function (pathAnim) {
                    ...
                    var Fx = $.fx,
                        ...
                        opacityHook =
                            $.cssHooks
                                .opacity; /* allow unused param x in this function */
                    ...
                    wrap(
                        opacityHook,
                        "get",
                        function (proceed, elem, computed) {
                            return elem.attr
                                ? elem.opacity || 0
                    ...
                    $.fn.highcharts = function () {
                        ...
                        if (this[0]) {
                            ...
                            if (options === UNDEFINED) {
                                ret =
                                    charts[
                                        attr(this[0], "data-highcharts-chart")
                                    ];
                            }
                        }
    ...
    defaultOptions = {
        ...
        global: {
            ...
            // timezoneOffset: 0,
            canvasToolsURL:
                "http://code.highcharts.com/4.0.1/modules/canvas-tools.js",
    ...
    SVGElement.prototype = {
        ...
        animate: function (params, options, complete) {
            ...
            if (animOptions) {
                ...
                if (complete) {
                    // allows using a callback with the global animation
        ...
        attr: function (hash, val) {
            ...
            if (typeof hash === "string") {
                ...
                for (key in hash) {
                    ...
                    if (!skipAttr) {
                        (this[key + "Setter"] || this._defaultSetter).call(
                            this,
                            value,
                            key,
                            element
  ...
  */
        ...
        crisp: function (rect) {
            ...
            rect.width = mathFloor(
                (rect.width || wrapper.width || 0) - 2 * normalizer
            );
            rect.height = mathFloor(
        ...
        dashstyleSetter: function (value) {
            ...
            if (value) {
                ...
                while (i--) {
                    value[i] =
                        pInt(value[i]) *
                        this.element.getAttribute("stroke-width");
                }
                value = value.join(",");
    ...
    SVGElement.prototype.translateXSetter = SVGElement.prototype.translateYSetter = SVGElement.prototype.rotationSetter = SVGElement.prototype.verticalAlignSetter = SVGElement.prototype.scaleXSetter = SVGElement.prototype.scaleYSetter = function (
        value,
        key
    ) {
        this[key] = value;
...
larger than 0 if (this.stroke && this['stroke-width']) {
    ...
    SVGRenderer.prototype = {
        ...
        rect: function (x, y, width, height, r, strokeWidth) {
            ...
            wrapper.rSetter = function (value) {
                attr(this.element, { rx: value, ry: value });
            };
        ...
        symbols: {
            ...
            arc: function (x, y, w, h, options) {
                var start = options.start,
                    ...
                    end = options.end - 0.001, // to prevent cos and sin of start and end from becoming
            ...
            callout: function (x, y, w, h, options) {
                var arrowLength = 6,
                    ...
                    path,
                    normalizer = (mathRound(options.strokeWidth || 0) % 2) / 2; // mathRound because strokeWidth can sometimes have
                // roundoff errors;
        ...
        label: function (
            ...
            function updateBoxSize() {
                ...
                bBox =
                    ...
                    text.getBBox();
                wrapper.width =
                    (width || bBox.width || 0) + 2 * padding + paddingLeft;
        ...
        htmlUpdateTransform: function () {
            ...
            if (elem.tagName === "SPAN") {
                ...
                if (currentTextTransform !== wrapper.cTT) {
                    // do the calculations and DOM access only if
                    // properties changed
    ...
    extend(SVGRenderer.prototype, {
        ...
        html: function (str, x, y) {
            ...
            wrapper.xSetter = wrapper.ySetter = wrapper.alignSetter = wrapper.rotationSetter = function (
                value,
                key
            ) {
                if (key === "align") {
    ...
    if (!hasSVG && !useCanVG) {
        ...
        Highcharts.VMLElement = VMLElement = {
            ...
            dashstyleSetter: function (value, key, element) {
                ...
                this[
                    key
                ] = value; /* because changing stroke-width will change the dash
            ...
            strokeSetter: function (value, key, element) {
                this.setAttr(
                    "strokecolor",
                    this.renderer.color(value, element, key)
                );
            },
            "stroke-widthSetter": function (value, key, element) {
    ...
    Tick.prototype = {
        ...
        getLabelSides: function () {
            var bBox = this.label.getBBox(),
                ...
                leftSide = horiz
                    ? labelOptions.x -
                      size * { left: 0, center: 0.5, right: 1 }[axis.labelAlign]
                    : 0,
        ...
        handleOverflow: function (index, xy) {
            ...
            if (
                labelEdge[line] === UNDEFINED ||
                pxPos + leftSide > labelEdge[line]
            ) {
    ...
    Axis.prototype = {
        ...
        init: function (chart, userOptions) {
            ...
            axis.tickmarkOffset =
                axis.categories && options.tickmarkPlacement === "between"
                    ? 0.5
                    : 0;
        ...
        setTickPositions: function (secondPass) {
            ...
            if (!tickPositions) {
                ...
                if (
                    ...
                    (axis.max - axis.min) / axis.tickInterval >
            ...
            if (!isLinked) {
                ...
                if (tickPositions.length === 1) {
                    singlePad = mathAbs(axis.max) > 10e12 ? 1 : 0.001; // The lowest possible number to avoid extra
        ...
        setScale: function () {
            ...
            each(axis.series, function (series) {
                if (
                    ...
                    // when x axis is dirty, we need new data
        ...
        setAxisSize: function () {
            ...
            if (percentRegex.test(top)) {
                top =
                    (parseInt(top, 10) / 100) * chart.plotHeight +
                    chart.plotTop;
            }
        ...
        getOffset: function () {
            var axis = this,
                ...
                lineHeightCorrection =
                    side === 2
                        ? renderer.fontMetrics(labelOptions.style.fontSize).b
                        : 0;
                ...
                if (
                    ...
                    while (autoStaggerLines < maxStaggerLines) {
                        ...
                        for (i = 0; i < sortedPositions.length; i++) {
                            ...
                            bBox =
                                ticks[pos].label && ticks[pos].label.getBBox();
                            w = bBox ? bBox.width : 0;
        ...
        render: function () {
            var axis = this,
                ...
                justifyLabels = (axis.justifyLabels =
                    horiz && overflow !== false),
                to;
                    ...
                    each(tickPositions, function (pos, i) {
                        if (i % 2 === 0 && pos < axis.max) {
                            if (!alternateBands[pos]) {
                                alternateBands[
                                    pos
                                ] = new Highcharts.PlotLineOrBand(axis);
                            }
        ...
        if (defined(min)) {
            ...
            var time = minDate.getTime(),
                ...
                localTimezoneOffset = useUTC
                    ? timezoneOffset
                    : (24 * 3600 * 1000 +
                          minDate.getTimezoneOffset() * 60 * 1000) %
                      (24 * 3600 * 1000); // #950
    ...
    Axis.prototype.normalizeTimeTickInterval = function (
        ...
        count = normalizeTickInterval(
            ...
            multiples,
            unit[0] === YEAR
                ? mathMax(getMagnitude(tickInterval / interval), 1)
                : 1 // #1913, #2360
        );
            ...
            while (element) {
                ...
                if (elemClassName) {
                    if (elemClassName.indexOf(className) !== -1) {
                        ...
                        elemClassName.indexOf(PREFIX + "container") !== -1
                    ) {
                        return false;
                    }
                }
    ...
    extend(Highcharts.Pointer.prototype, {
        ...
        pinchTranslateDirection: function (
            ...
            var chart = this.chart,
                ...
                setScale = function () {
                    if (
                        !singleTouch &&
                        mathAbs(touch0Start - touch1Start) > 20
                    ) {
        ...
        pinch: function (e) {
            ...
            if (e.type === "touchstart") {
                ...
                // can be 0 when releasing, if touchend fires
                // first
    ...
    Legend.prototype = {
        ...
        colorizeItem: function (item, visible) {
            var legend = this,
                ...
                symbolColor = visible
                    ? item.legendColor || item.color || "#CCC"
                    : hiddenColor,
        ...
        renderItem: function (item) {
            var legend = this,
                ...
                li = item.legendItem,
                series =
                    item.series && item.series.drawLegendSymbol
                        ? item.series
                        : item,
            ...
            if (!li) {
                ...
                item.legendItem = li = renderer
                    ...
                    .css(merge(item.visible ? itemStyle : itemHiddenStyle)) // merge to prevent modifying
                    // original (#1021)
                    .attr({ align: ltr ? "left" : "right", zIndex: 2 })
                    .add(item.legendGroup);

                if (legend.setItemEvents) {
                    legend.setItemEvents(
                        item,
                        li,
                        useHTML,
                        itemStyle,
            ...
            itemWidth = item.checkboxOffset =
                ...
                symbolWidth +
                    ...
                    itemDistance +
                    (showCheckbox ? 20 : 0);
            legend.itemHeight = itemHeight = mathRound(
                item.legendItemHeight || bBox.height
            );
        ...
        scroll: function (scrollBy, animation) {
            ...
            if (currentPage > 0) {
                ...
                this.nav.attr({
                    translateX: padding,
                    translateY:
                        clipHeight + this.padding + 7 + this.titleHeight,
                    visibility: VISIBLE,
                });
                this.up
                    .attr({
        ...
        drawLineMarker: function (legend) {
            var options = this.options,
                ...
                verticalCenter =
                    legend.baseline -
                    mathRound(
                        renderer.fontMetrics(legendOptions.itemStyle.fontSize)
                            .b * 0.3
                    ),
                attr;
        ...
        wrap(Legend.prototype, "positionItem", function (proceed, item) {
            var legend = this,
                runPositionItem = function () {
                    // If chart destroyed in sync, this is
                    // undefined (#2030)
    ...
    Chart.prototype = {
        ...
        getStacks: function () {
            ...
            each(chart.series, function (series) {
                if (
                    ...
                    series.stackKey =
                        series.type + pick(series.options.stack, "");
                }
            });
        },
        ...
        layOutTitles: function (redraw) {
            ...
            if (subtitle) {
                ...
                if (
                    !subtitleOptions.floating &&
                    !subtitleOptions.verticalAlign
                ) {
                    titleOffset = mathCeil(
                        titleOffset + subtitle.getBBox().height
                    );
                }
            }
        ...
        reflow: function (e) {
            var chart = this,
                ...
                doReflow = function () {
                    if (chart.container) {
                        // It may have been destroyed in the meantime
                        // (#1257)
        ...
        setChartSize: function (skipAxes) {
            ...
            chart.clipBox = {
                ...
                width: mathFloor(
                    chart.plotSizeX -
                        mathMax(plotBorderWidth, clipOffset[1]) / 2 -
                        clipX
                ),
                height: mathFloor(
                    chart.plotSizeY -
                        mathMax(plotBorderWidth, clipOffset[2]) / 2 -
                        clipY
                ),
            };
                ...
                return (
                    (isPercent
                        ? // i == 0: centerX, relative to width
                          ...
                          ([plotWidth, plotHeight, smallestSize, smallestSize][
                              i
                          ] *
                              pInt(length)) /
                          100
    ...
    Point.prototype = {
        ...
        destroy: function () {
            ...
            if (point.graphic || point.dataLabel) {
                // removeEvent and destroyElements
    ...
    Series.prototype = {
        ...
        init: function (chart, options) {
            var series = this,
                ...
                sortByIndex = function (a, b) {
                    return (
                        pick(a.options.index, a._i) -
                        pick(b.options.index, b._i)
                    );
                };
        ...
        setOptions: function (itemOptions) {
            ...
            this.tooltipOptions = merge(
                ...
                userPlotOptions[this.type] &&
                    userPlotOptions[this.type].tooltip,
                itemOptions.tooltip
            );
        ...
        processData: function (force) {
            ...
            for (i = processedXData.length - 1; i >= 0; i--) {
                ...
                if (
                    !cropped &&
                    processedXData[i] > min &&
                    processedXData[i] < max
                ) {
                    activePointCount++;
                }
                if (
        ...
        afterAnimate: function () {
            ...
            if (group && this.options.clip !== false) {
                if (!sharedClipKey || !clipBox) {
                    group.clip(
                        clipBox
                            ? chart.renderer.clipRect(clipBox)
                            : chart.clipRect
                    );
                }
            ...
            if (
                ...
                while (i--) {
                    ...
                    if (
                        ...
                        if (graphic) {
                            // update
                            graphic[isInside ? "show" : "hide"](true) // Since the marker group isn't clipped, each individual
        ...
        getAttribs: function () {
            ...
            if (
                ...
                while (i--) {
                    point = points[i];
                    normalOptions =
                        (point.options && point.options.marker) ||
                        point.options;
                    ...
                    if (point.options) {
                        for (key in pointAttrToOptions) {
                            if (
                                defined(normalOptions[pointAttrToOptions[key]])
                            ) {
                    ...
                    if (hasPointSpecificOptions) {
                        ...
                        if (!defaultFillColor) {
                            // Individual point color or negative color
                            // markers (#2219)
        ...
        getSegmentPath: function (segment) {
            ...
            each(segment, function (point, i) {
                ...
                if (series.getPointSpline) {
                    // generate the spline as defined in the
                    // SplineSeries object
        ...
        render: function (group) {
            ...
            if (this.label) {
                ...
                this.label = this.axis.chart.renderer
                    .text(str, null, null, options.useHTML) // dummy positions, actual position updated
    ...
    Axis.prototype.buildStacks = function () {
        ...
        if (!this.isXAxis) {
            ...
            while (i--) {
                series[
                    reversedStacks ? i : series.length - i - 1
                ].setStackedPoints();
            }
        ...
        each([stackKey, "-" + stackKey], function (key) {
            ...
            while (i--) {
                ...
                if (pointExtremes) {
                    ...
                    pointExtremes[0] = correctFloat(
                        pointExtremes[0] * totalFactor
                    ); // Y bottom value
                    pointExtremes[1] = correctFloat(
                        pointExtremes[1] * totalFactor
                    ); // Y value
    ...
    extend(Chart.prototype, {
        ...
        addAxis: function (options, isX, redraw, animation) {
            ...
            axis = new Axis(
                this,
                merge(options, { index: this[key].length, isX: isX })
            );
            /*jslint unused: true*/
    ...
    extend(Series.prototype, {
        ...
        addPoint: function (options, redraw, shift, animation) {
            ...
            if (shift) {
                each(
                    [graph, area, series.graphNeg, series.areaNeg],
                    function (shape) {
                        if (shape) {
    ...
    */
            ...
            if (!init) {
                each(points, function (point) {
                    ...
                    if (graphic) {
                        ...
                        // animate
                        graphic.animate(
                            { r: args.r, start: args.start, end: args.end },
        ...
        seriesTypes.pie.prototype.verifyDataLabelOverflow = function (
            ...
            if (centerOption[1] !== null) {
                ...
                newSize = mathMax(
                    mathMin(
                        newSize,
                        center[2] - mathMax(overflow[0], overflow[2])
                    ),
                    minSize
                );
            } else {
        ...
        seriesTypes.column.prototype.alignDataLabel = function (
            ...
            var chart = this.chart,
                ...
                below =
                    point.below ||
                    point.plotY >
                        pick(this.translatedThreshold, chart.plotSizeY),
            ...
            each(panning === "xy" ? [1, 0] : [1], function (isX) {
                ...
                var mousePos = e[isX ? "chartX" : "chartY"],
                    ...
                    newMax =
                        axis.toValue(
                            startPos +
                                chart[isX ? "plotWidth" : "plotHeight"] -
                                mousePos,
                            true
                        ) - halfPointRange;
    ...
    extend(Point.prototype, {
        ...
        setState: function (state, move) {
            ...
            if (point.graphic) {
                radius =
                    markerOptions && point.graphic.symbolName && pointAttr.r;
                point.graphic.attr(
                    merge(
                        pointAttr,
                        radius
        ...
        haloPath: function (size) {
            ...
            return chart.renderer.symbols.circle(
                plotBox.translateX +
                    (inverted ? series.yAxis.len - this.plotY : this.plotX) -
                    size,
                plotBox.translateY +
                    (inverted ? series.xAxis.len - this.plotX : this.plotY) -
                    size,
                size * 2,
                size * 2
            );
