  ...
  if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1 || b[0] > 3)
    ...
    +function(a) {
      ...
      d.prototype.close = function(b) {
        ...
        var g = a("#" === f ? [] : f);
        b && b.preventDefault(), g.length || (g = e.closest(".alert")),
            g.trigger(b = a.Event("close.bs.alert")),
            b.isDefaultPrevented() ||
                (g.removeClass("in"),
                 a.support.transition && g.hasClass("fade")
                     ? g.one("bsTransitionEnd", c)
                           .emulateTransitionEnd(d.TRANSITION_DURATION)
                     : c())
      };
      var e = a.fn.alert;
      a.fn.alert = b, a.fn.alert.Constructor = d,
                ...
                b.call(d, "toggle"),
                    a(c.target).is(
                        ...
                        (c.preventDefault(),
                         d.is("input,button")
                             ? d.trigger("focus")
                             : d.find("input:visible,button:visible")
                                   .first()
                                   .trigger("focus"))
              })
    ...
    +function(a) {
      ...
      var c = function(b, c) {
        ...
        this.options = c, this.paused = null, this.sliding = null,
        this.interval = null, this.$active = null, this.$items = null,
      ...
      c.VERSION = "3.3.7", c.TRANSITION_DURATION = 600,
      ...
      c.prototype.keydown = function(a) {
        ...
        var b = this, c = this.getItemIndex(
        ...
        if (this.$element.trigger(k), !k.isDefaultPrevented()) {
          ...
          var m =
              a.Event("slid.bs.carousel", {relatedTarget : j, direction : h});
          return a.support.transition && this.$element.hasClass("slide")
                     ? (f.addClass(b), f[0].offsetWidth, e.addClass(h),
                        f.addClass(h),
                     ...
                     : (e.removeClass("active"), f.addClass("active"),
                        this.sliding = !1, this.$element.trigger(m)),
                 g && this.cycle(), this
        }
      };
      var d = a.fn.carousel;
      ...
      var e = function(c) {
        var d, e = a(this),
               f = a(e.attr("data-target") ||
                     (d = e.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, ""));
        if (f.hasClass("carousel")) {
          var g = a.extend({}, f.data(), e.data()), h = e.attr("data-slide-to");
          h && (g.interval = !1), b.call(f, g),
              h && f.data("bs.carousel").to(h), c.preventDefault()
        }
      };
      a(document)
    ...
    +function(a) {
      ...
      d.VERSION = "3.3.7", d.TRANSITION_DURATION = 350,
      d.DEFAULTS = {toggle : !0}, d.prototype.dimension = function() {
    ...
    +function(a) {
      ...
      var h = a.fn.dropdown;
      a.fn.dropdown = d, a.fn.dropdown.Constructor = g,
    ...
    +function(a) {
      ...
      c.VERSION = "3.3.7", c.TRANSITION_DURATION = 300,
      c.BACKDROP_TRANSITION_DURATION = 150,
      c.DEFAULTS = {backdrop : !0, keyboard : !0, show : !0},
      c.prototype.toggle = function(
          a) { return this.isShown ? this.hide() : this.show(a) },
      c.prototype.show = function(b) {
                ...
                (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(),
                 ...
                 this.$dialog.on("mousedown.dismiss.bs.modal", function() {
                   ...
                   d.$element.parent().length || d.$element.appendTo(d.$body),
                       d.$element.show().scrollTop(0), d.adjustDialog(),
        ...
        b && b.preventDefault(),
            b = a.Event("hide.bs.modal"), this.$element.trigger(b),
            this.isShown && !b.isDefaultPrevented() &&
                (this.isShown = !1, this.escape(), this.resize(),
        ...
        a(document)
            ...
            .on("focusin.bs.modal", a.proxy(function(a) {
              document === a.target || this.$element[0] === a.target ||
        ...
        this.isShown && this.options.keyboard
            ? this.$element.on(
                  ...
                  a.proxy(function(a) { 27 == a.which && this.hide() }, this))
          ...
          if (this.$backdrop = a(document.createElement("div"))
              ...
              this.$element.on(
                  ...
                  a.proxy(
                      ...
                      this)),
              f && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"),
              !b)
            return;
      ...
      var d = a.fn.modal;
      a.fn.modal = b, a.fn.modal.Constructor = c,
      ...
      a(document).on(
          "click.bs.modal.data-api", '[data-toggle="modal"]', function(c) {
            var d = a(this), e = d.attr("href"),
                f = a(d.attr("data-target") ||
                      e && e.replace(/.*(?=#[^\s]+$)/, "")),
                g = f.data("bs.modal") ? "toggle"
                                       : a.extend({remote : !/#/.test(e) && e},
                                                  f.data(), d.data());
    ...
    +function(a) {
        ...
        for (var e = this.options.trigger.split(" "), f = e.length; f--;) {
          ...
          if ("click" == g)
            ...
            this.$element.on(h + "." + this.type, this.options.selector,
                ...
                this.$element.on(i + "." + this.type, this.options.selector,
      ...
      c.prototype.getOptions = function(b) {
        ...
        var c = b instanceof this.constructor
                    ? b
                    : a(b.currentTarget).data("bs." + this.type);
        if (c || (c = new this.constructor(b.currentTarget,
                                           this.getDelegateOptions()),
                  a(b.currentTarget).data("bs." + this.type, c)),
            b instanceof a.Event &&
                 ...
                 c.options.delay && c.options.delay.hide
                     ? void (
                           c.timeout = setTimeout(
                               function() { "out" == c.hoverState && c.hide() },
        ...
        if (this.hasContent() && this.enabled) {
          ...
          var h = "function" == typeof this.options.placement
                      ? this.options.placement.call(this, f[0],
                                                    this.$element[0])
          ...
          if (j) {
            ...
            h = "bottom" == h && k.bottom + m > o.bottom ? "top"
                : "top" == h && k.top - m < o.top        ? "bottom"
                : "right" == h && k.right + l > o.width  ? "left"
                : "left" == h && k.left - l < o.left     ? "right"
                                                         : h,
        ...
        function d() {
          "in" != e.hoverState && f.detach(),
              e.$element && e.$element.removeAttr("aria-describedby")
      ...
      var d = a.fn.tooltip;
      a.fn.tooltip = b, a.fn.tooltip.Constructor = c,
      a.fn.tooltip.noConflict = function() { return a.fn.tooltip = d, this }
    }(jQuery),
    +function(a) {
      "use strict";
      function b(b) {
      ...
      c.prototype.setContent = function() {
        ...
        return a.attr("data-content") ||
               ("function" == typeof b.content ? b.content.call(a[0])
                                               : b.content)
      }, c.prototype.arrow = function() {
      ...
      a.fn.popover.noConflict = function() { return a.fn.popover = d, this }
    }(jQuery),
    +function(a) {
      "use strict";
      function b(c, d) {
      ...
      b.prototype.getScrollHeight = function() {
        ...
        this.$body.find(this.selector)
            ...
            .each(
                function() { b.offsets.push(this[0]), b.targets.push(this[1]) })
      ...
      a.fn.scrollspy.noConflict =
          function() { return a.fn.scrollspy = d, this },
    ...
    +function(a) {
      ...
      c.VERSION = "3.3.7", c.RESET = "affix affix-top affix-bottom",
      ...
      c.prototype.getState = function(a, b, c, d) {
        ...
        if ("bottom" == this.affixed)
          return null != c ? !(e + this.unpin <= f.top) && "bottom"
                           : !(e + g <= a - d) && "bottom";
        var h = null == this.affixed, i = h ? e : f.top, j = h ? g : b;
        return null != c && e <= c ? "top"
      ...
      var d = a.fn.affix;
      a.fn.affix = b, a.fn.affix.Constructor = c,
