        ...
        tablesorter: new (function () {
            ...
            function detectParserForColumn(table, rows, rowIndex, cellIndex) {
                ...
                while (nodeValue == "" && keepLooking) {
                    rowIndex++;
                    if (rows[rowIndex]) {
                        node = getNodeFromRowAndCellIndex(
                            rows,
                            rowIndex,
                            cellIndex
                        );
                        ...
                        if (table.config.debug) {
                            log(
                                "Checking if value was empty on row:" + rowIndex
                            );
                        }
                    } else {
                        keepLooking = false;
            ...
            function checkCellColSpan(table, rows, row) {
                ...
                for (var i = 0; i < c.length; i++) {
                    ...
                    if (cell.colSpan > 1) {
                        arr = arr.concat(
                            checkCellColSpan(table, headerArr, row++)
                        );
                    } else {
                        if (
            ...
            this.addParser = function (parser) {
                ...
                for (var i = 0; i < l; i++) {
                    if (
                        parsers[i].id.toLowerCase() == parser.id.toLowerCase()
                    ) {
                        a = false;
                    }
                }
