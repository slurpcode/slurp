...
fig.savefig(sp + "violin-plot-of-automobile-cylinders-versus-horsepower.png",
            dpi=80)
fig.clf()
...
fig = plt.gcf()
fig.set_size_inches(8, 8)
fig.savefig(sp + "swarmplot-of-automobile-horsepower-versus-cylinders.png",
            dpi=80)
fig.clf()
...
fig = plt.gcf()
fig.set_size_inches(8, 8)
fig.savefig(sp + "automobile-weight-versus-horsepower-by-continent.png",
            dpi=80)
fig.clf()
...
fig = plt.gcf()
fig.set_size_inches(8, 8)
fig.savefig(sp + "automobile-hexbin-jointplot-of-horsepower-versus-mpg.png",
            dpi=80)
fig.clf()

df = auto.loc[:, [
    "mpg", "cyl", "displ", "hp", "weight", "accel", "origin", "color"
]]
sns.set(style="ticks")
