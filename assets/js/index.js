document.addEventListener('click', function(e) {
  Cookies.set('clicks',
              Cookies.get('clicks') && (+Cookies.get('clicks') + 1) || 0);
  let x;
  ...
  var cols = [
    'cyan',        'yellow', 'darkpink', 'red',    'blue',    'green',
    'white',       'olive',  'black',    'lime',   'fuchsia', 'purple',
    'navy',        'teal',   'aqua',     'maroon', 'pink',    'deeppink',
    'lightsalmon', 'teal',   'ivory',    'orange', 'peru',    'plum'
  ];
  ...
  case 11:
    ...
    var MAIN_OPTS = Object.assign({}, OPTS, {stroke : 'cyan'})
    ...
    for (let i = 0; i < 10; i++) {
      ...
      smallCircles.push(new mojs.Shape({SMALL_OPTS}));
    }
...
anime.timeline({loop : true})
    ...
    .add({targets : '.ml4', opacity : 0, duration : 500, delay : 500});