gdjs.TextRuntimeObjectPixiRenderer = function(runtimeObject, runtimeScene) {
  ...
  runtimeScene.getLayer("").getRenderer().addRendererObject(
      this._text, runtimeObject.getZOrder());
...
gdjs.TextRuntimeObjectRenderer =
    gdjs.TextRuntimeObjectPixiRenderer; // Register the class to let the engine
                                        // use it.

gdjs.TextRuntimeObjectPixiRenderer.prototype.getRendererObject =
...
gdjs.TextRuntimeObjectPixiRenderer.prototype.ensureUpToDate = function() {
  if (this._justCreated) { // Work around a PIXI.js bug:
    ...
    this.updatePosition(); // Width seems not to be correct when text is not
                           // rendered yet.
...
gdjs.TextRuntimeObjectPixiRenderer.prototype.updateStyle = function() {
  ...
  style.stroke = gdjs.rgbToHexNumber(this._object._outlineColor[0],
  ...
  style.dropShadowColor = gdjs.rgbToHexNumber(this._object._shadowColor[0],
...
gdjs.TextRuntimeObjectPixiRenderer.prototype.updateAngle =
    function() { this._text.rotation = gdjs.toRad(this._object.angle); };

gdjs.TextRuntimeObjectPixiRenderer.prototype.updateOpacity =
    function() { this._text.alpha = this._object.opacity / 255; };
...
gdjs.TextRuntimeObjectPixiRenderer.prototype.getWidth =
    function() { return this._text.width; };

gdjs.TextRuntimeObjectPixiRenderer.prototype.getHeight =
    function() { return this._text.height; };

gdjs.TextRuntimeObjectPixiRenderer.prototype._getColorHex =
    function() {
  return gdjs.rgbToHexNumber(this._object._color[0], this._object._color[1],
                             this._object._color[2]);
}

    gdjs.TextRuntimeObjectPixiRenderer.prototype._getGradientHex =
        function() {
  var gradient = [];
  for (var colorIndex = 0; colorIndex < this._object._gradient.length;
       colorIndex++) {
    gradient.push('#' + gdjs.rgbToHex(this._object._gradient[colorIndex][0],
  ...
  return gradient;
         ...
         */
        gdjs.TextRuntimeObjectPixiRenderer.prototype.getScaleX =
            function() { return this._text.scale.x; };

/**
 * Get x-scale of the text.
 */
gdjs.TextRuntimeObjectPixiRenderer.prototype.getScaleY =
    function() { return this._text.scale.y; };
 ...
 */
gdjs.TextRuntimeObjectPixiRenderer.prototype.setScaleX = function(
    newScale) { this._text.scale.x = newScale; };

/**
 * Set the text object y-scale.
 * @param {number} newScale The new y-scale for the text object.
 */
gdjs.TextRuntimeObjectPixiRenderer.prototype.setScaleY = function(
    newScale) { this._text.scale.y = newScale; };
