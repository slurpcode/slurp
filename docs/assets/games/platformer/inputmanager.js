 ...
 * Copyright 2013-2016 Florian Rival (Florian.Rival@gmail.com). All rights
 ...
 */
gdjs.InputManager.prototype.getLastPressedKey =
    function() { return this._lastPressedKey; };
...
gdjs.InputManager.prototype.isKeyPressed = function(keyCode) {
  return this._pressedKeys.containsKey(keyCode) &&
         this._pressedKeys.get(keyCode);
};

/**
 * Return true if the key corresponding to keyCode was released during the last
 * frame.
 * @param {number} keyCode The key code to be tested.
 */
gdjs.InputManager.prototype.wasKeyReleased = function(keyCode) {
  return this._releasedKeys.containsKey(keyCode) &&
         this._releasedKeys.get(keyCode);
};
 ...
 * Please note that the coordinates must be expressed relative to the view
 * position.
 *
 ...
 */
gdjs.InputManager.prototype.getMouseX = function() { return this._mouseX; };
 ...
 */
gdjs.InputManager.prototype.getMouseY = function() { return this._mouseY; };

/**
 * Should be called whenever a mouse button is pressed
 * @param {number} buttonCode The mouse button code associated to the event.
 * See gdjs.InputManager.MOUSE_LEFT_BUTTON,
 * gdjs.InputManager.MOUSE_RIGHT_BUTTON, gdjs.InputManager.MOUSE_MIDDLE_BUTTON
 */
 ...
 * @param {number} buttonCode The mouse button code (0: Left button, 1: Right
 *     button).
 */
gdjs.InputManager.prototype.isMouseButtonPressed = function(buttonCode) {
  return this._pressedMouseButtons[buttonCode] !== undefined &&
         this._pressedMouseButtons[buttonCode];
};

/**
 * Return true if the mouse button corresponding to buttonCode was just
 * released.
 * @param {number} buttonCode The mouse button code (0: Left button, 1: Right
 *     button).
 */
gdjs.InputManager.prototype.isMouseButtonReleased = function(buttonCode) {
  return this._releasedMouseButtons[buttonCode] !== undefined &&
 ...
 */
gdjs.InputManager.prototype.onMouseWheel = function(
    wheelDelta) { this._mouseWheelDelta = wheelDelta; };

/**
 * Return the mouse wheel delta
 */
gdjs.InputManager.prototype.getMouseWheelDelta =
    function() { return this._mouseWheelDelta; };
...
gdjs.InputManager.prototype.onTouchEnd = function(identifier) {
  ...
  if (this._touches.containsKey(
          identifier)) { // Postpone deletion at the end of the frame
...
gdjs.InputManager.prototype.getStartedTouchIdentifiers =
    function() { return this._startedTouches; };

gdjs.InputManager.prototype.popStartedTouch =
    function() { return this._startedTouches.shift(); };

gdjs.InputManager.prototype.popEndedTouch =
    function() { return this._endedTouches.shift(); };
 ...
 *
 * This method should be called in the game loop (see
 * gdjs.RuntimeGame.startGameLoop).
 */
 ...
 */
gdjs.InputManager.prototype.isScrollingUp =
    function() { return this.getMouseWheelDelta() > 0; };

/**
 * Return true if the mouse wheel scroll to down
 */
gdjs.InputManager.prototype.isScrollingDown =
    function() { return this.getMouseWheelDelta() < 0; };
